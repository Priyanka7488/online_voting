...
if(isset($_POST["BJP"])){
$value="BJP";}	
elseif(isset($_POST["AAP"])){
$value="AAP";
}
elseif(isset($_POST["INC"])){
$value="INC";
}
elseif(isset($_POST["JDU"])){
$value="JDU";
}
...
if($rs!=0)
{
	...
	$subject="OTP Verfication for Vote Cast ";
                                        ...
                                        while($row=mysqli_fetch_assoc($rt))
                                               ...
                                               echo "<td><img src='$imgparty' width=70 height=70></><br>";
                                                echo  '<td>
                                                 ...
                                                 name="'.$partyname.'" value="vote" id="votebtn">';
                                                echo '</td>';
                                                echo '</tr>';
                                               }
                                    ?>
